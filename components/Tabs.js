        ...
        <div className="py-12 md:py-20">
          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
              <button
                className={`flex items-center font-medium py-2 px-4 m-2 bg-gray-200 rounded-full group transition duration-500 ${tab !== 1 && "opacity-50"}`}
                onClick={() => setTab(1)}
              >
                ...
                <span className="text-gray-600 group-hover:text-gray-700 transition-colors duration-150 ease-in-out">Quick action</span>
              </button>
              <button
                className={`flex items-center font-medium py-2 px-4 m-2 bg-gray-200 rounded-full group transition duration-500 ${tab !== 2 && "opacity-50"}`}
                onClick={() => setTab(2)}
              >
                <svg className="w-4 h-4 fill-current text-purple-600 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
              ...
              <button
                className={`flex items-center font-medium py-2 px-4 m-2 bg-gray-200 rounded-full group transition duration-500 ${tab !== 3 && "opacity-50"}`}
                onClick={() => setTab(3)}
              >
                <svg className="w-4 h-4 fill-current text-purple-600 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
              ...
              <button
                className={`flex items-center font-medium py-2 px-4 m-2 bg-gray-200 rounded-full group transition duration-500 ${tab !== 4 && "opacity-50"}`}
                onClick={() => setTab(4)}
              >
                <svg className="w-4 h-4 fill-current text-purple-600 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
              ...
              <button
                className={`flex items-center font-medium py-2 px-4 m-2 bg-gray-200 rounded-full group transition duration-500 ${tab !== 5 && "opacity-50"}`}
                onClick={() => setTab(5)}
              >
                <svg className="w-4 h-4 fill-current text-purple-600 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="relative flex flex-col mt-16" data-aos="fade-up" ref={tabs}>
              ...
              >
                <article className="relative max-w-md mx-auto md:max-w-none">
                  <figure className="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    <Image src="/images/tabs-image-01.jpg" alt="Tab1" layout="fill" className="w-full h-full object-cover" />
                  </figure>
                  <div className="relative bg-gray-100 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
              ...
              >
                <article className="relative max-w-md mx-auto md:max-w-none">
                  <figure className="md:absolute md:inset-y-0 md:left-0 md:w-1/2">
                    <Image src="/images/hero-image-01.jpg" alt="Tab2" layout="fill" className="w-full h-full object-cover" />
                  </figure>
                  <div className="relative bg-gray-100 py-8 md:py-16 px-6 md:pl-16 md:max-w-lg lg:max-w-xl md:ml-auto">
              ...
              >
                <article className="relative max-w-md mx-auto md:max-w-none">
                  <figure className="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    <Image src="/images/tabs-image-01.jpg" alt="Tabs01" layout="fill" className="w-full h-full object-cover" />
                  </figure>
                  <div className="relative bg-gray-100 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                    <h4 className="h4 mb-2">Optimize and scale, easy to start</h4>
                    <p className="text-lg text-gray-500">
