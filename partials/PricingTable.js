          ...
          <div>
            ...
            <div className="flex justify-center mb-16" data-aos="fade-up" data-aos-delay="400">
              <div className="inline-flex items-center">
                <div className="text-gray-800 font-medium mr-3">9 Weeks</div>
                ...
                <div className="text-gray-800 font-medium ml-3">6 Weeks</div>
              </div>
            </div>
            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
              ...
              <div className="relative flex flex-col h-full p-6 bg-plato-900 rounded-md" data-aos="fade-up" data-aos-delay="600">
                ...
                <div className="mb-4 pb-4 border-b border-plato-800">
                  ...
                  <div className="inline-flex items-baseline mb-2">
                    <span className="text-2xl md:text-3xl font-medium text-white">{priceOutput.plan2[value][0]}</span>
              ...
              <div className="relative flex flex-col h-full p-6 bg-plato-900 rounded-md" data-aos="fade-up" data-aos-delay="800">
                ...
                <div className="mb-4 pb-4 border-b border-plato-800">
                  ...
                  <div className="inline-flex items-baseline mb-2">
                    <span className="text-2xl md:text-3xl font-medium text-white">{priceOutput.plan3[value][0]}</span>
                    <span className="h2 text-white">{priceOutput.plan3[value][1]}</span>
                    <span className="font-medium text-white">{priceOutput.plan3[value][2]}</span>
                  </div>
            ...
            {/* Bottom infobox */}
            <div className="flex flex-col lg:flex-row justify-between items-center mt-12 lg:mt-6 lg:py-8">
              <div className="font-medium text-lg text-center lg:text-left mb-4 lg:mb-0">Expecting more than 1000 Active End Users?</div>
              <div>
                <a className="btn-sm text-white bg-plato-900 hover:bg-plato-800" href="#0">
                  Contact us
                </a>
              </div>
            </div>
