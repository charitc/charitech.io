            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="relative inline-flex flex-col mb-6" data-aos="fade-up">
                  <img className="rounded-full" src="/images/404.jpg" width="196" height="196" alt="404" />
                ...
                <h1 className="h1 mb-4" data-aos="fade-up" data-aos-delay="200">
                  <span>Uh oh.</span>
                  <span> {statusCode ? "An ${statusCode} occured on server" : "An error occured on client"}</span>
                </h1>
                <p className="text-lg text-gray-400" data-aos="fade-up" data-aos-delay="400">
                  Head to our{" "}
                  <Link href="/">
                    <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">homepage</a>
                  </Link>{" "}
