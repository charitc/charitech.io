    ...
    <section className="antialiased">
      <div className="flex flex-col min-h-screen overflow-hidden">
        ...
        <main className="flex-grow">
          ...
          {/*  Page sections */}
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 antialiased">
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              <div className="flex flex-col md:flex-row">
                ...
                <main className="md:flex-auto md:pl-10 order-1" data-aos="fade-up">
                  ...
                  <div className={page !== 1 ? "hidden" : undefined}>
                    <div className="mb-8">
                      ...
                      <p className="text-gray-500">
                        Last updated - <span className="text-gray-500">June 30, 2020</span>
                      </p>
                    </div>
                    <ul className="-my-4">
                      <li className="py-4">
                  ...
                  <div className={page !== 2 ? "hidden" : undefined}>
                    <div className="mb-8">
                      ...
                      <p className="text-gray-500">
                        Last updated - <span className="text-zomp-600">June 30, 2020</span>
                      </p>
                    </div>
                    <ul className="-my-4">
                      <li className="py-4">
                ...
                <aside className="md:w-64 mb-16 md:mb-0 md:mr-10 md:flex-shrink-0" data-aos="fade-up" data-aos-delay="200">
                  <h4 className="text-lg font-medium px-3 pb-3 border-b border-coral-200">Choose a category</h4>
                  <nav>
                    <ul>
                      <li className="py-2 border-b border-coral-200">
                        <a
                          className={`flex items-center px-3 group text-gray-800 hover:text-zomp-600 transition duration-150 ease-in-out ${
                            page === 1 && "text-zomp-600"
                          }`}
                          href="#0"
                          onClick={(e) => {
                            e.preventDefault();
                        ...
                        >
                          ...
                          <svg
                            className="w-3 h-3 fill-current flex-shrink-0 ml-2 opacity-0 group-hover:opacity-100 group-hover:text-zomp-600 group-hover:translate-x-1 transition duration-150 ease-in-out transform"
                            viewBox="0 0 12 12"
