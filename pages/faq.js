                ...
                <div className={page !== 1 ? "hidden" : undefined}>
                  <div className="mb-8">
                    ...
                    <p className="text-gray-500">
                      Last updated - <span className="text-purple-600">June 30, 2020</span>
                    </p>
                  </div>
                  <ul className="-my-4">
                    <li className="py-4">
                ...
                <nav>
                  <ul>
                    <li className="py-2 border-b border-gray-100">
                      <a
                        className={`flex items-center px-3 group text-gray-500 hover:text-purple-600 transition duration-150 ease-in-out ${
