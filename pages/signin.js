            ...
            <div className="pt-32 pb-12 md:pt-40 md:pb-20">
              ...
              <div className="max-w-sm mx-auto">
                    ...
                    <div className="w-full px-3">
                      <div className="flex justify-between">
                        ...
                        <Link href="/reset-password">
                          <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Forgot Password?</a>
                        </Link>
                      </div>
                    </div>
                  </div>
                ...
                <div className="text-gray-400 text-center mt-6">
                  ...
                  <Link href="/signup">
                    <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Sign up</a>
                  </Link>
                </div>
              </div>
            </div>
